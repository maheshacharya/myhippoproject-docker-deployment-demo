#Part of instructions are copied from https://github.com/docker-library/tomcat/blob/master/8.0/jre8/Dockerfile
FROM openjdk:8-jre
...
#ENV JRC_OPTS="-Dorg.apache.jackrabbit.core.cluster.node_id=$HOSTNAME"
